...
public class MergeJsonFiles {
    public static void main(String[] args) {
        ...
        try {
            // Read two JSON files
            JsonNode json1 = objectMapper.readTree(new File("C:\\Backup\\JsonData\\src\\main\\java\\org\\example\\file1.json"));
            JsonNode json2 = objectMapper.readTree(new File("C:\\Backup\\JsonData\\src\\main\\java\\org\\example\\file2.json"));
